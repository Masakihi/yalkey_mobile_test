                      ...
                      Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              bool passwordValid = RegExp(r"^[a-zA-Z0-9]{8,}").hasMatch(value);
                              if (!passwordValid) {
                                return 'パスワードは8文字以上の半角英数字で設定してください';
                              }
                              return null;
                      ...
                      Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              ...
                              bool userIdValid = RegExp(r"^[a-zA-Z0-9_]").hasMatch(value);
                              if (!userIdValid) {
                                return 'パスワードは8文字以上の半角英数字で設定してください';
                              }
                              return null;
                              ...
                              text: TextSpan(children: [
                                TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () {
                                        _launchInBrowser("https://yalkey.net/ja/terms-of-use/");
                                      }),
                                TextSpan(
                                  text: 'に同意する',
                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: _isAgreed ? const Color(0xFFAE0103) : Colors.grey,
