...
class _PasswordUpdatePageState extends State<PasswordUpdatePage> {
  ...
  Future<void> passwordUpdate(BuildContext context, oldPassword, newPassword, newPassword2nd) async {
    try {
      final response = await httpPost('password-change/', {'old_password': oldPassword, 'new_password1': newPassword, 'new_password2': newPassword2nd});
    } catch (error) {
