...
class SearchRecommendUserListPage extends StatefulWidget {
  ...
  @override
  _SearchRecommendUserListPageState createState() =>
      _SearchRecommendUserListPageState();
}

class _SearchRecommendUserListPageState
    extends State<SearchRecommendUserListPage> {
  ...
  Future<void> _fetchRecommendUserList() async {
    ...
    if (mounted) {
      setState(() {
        _userList.addAll(
            recommendUserListResponse.recommendUserList); // 新しいデータをリストに追加
