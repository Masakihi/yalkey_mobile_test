...
class SearchUserIdListPage extends StatefulWidget {
  // 画面遷移元からのデータを受け取る変数
  final String keyword;
  const SearchUserIdListPage({Key? key, required this.keyword})
      : super(key: key);

  @override
  _SearchUserIdListPageState createState() => _SearchUserIdListPageState();
}

class _SearchUserIdListPageState extends State<SearchUserIdListPage> {
  ...
  void initState() {
    ...
    _fetchSearchUserIdList(); // 最初のデータを読み込む
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          !_loading ? const SizedBox(height: 20.0) : const SizedBox.shrink(),
          !_loading
              ? Container(
          ...
          !_loading ? const SizedBox(height: 10.0) : const SizedBox.shrink(),
          Expanded(
