...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _fetchReportList() async {
    ...
    ReportListResponse reportListResponse =
        await ReportListResponse.fetchReportListResponse(
            _profileData!['login_user_profile']['user_number']);
    if (mounted) {
      setState(() {
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final report = _reportListMap['num_report_list']?[index];
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final report = _reportListMap['bool_report_list']?[index];
