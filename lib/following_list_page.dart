...
class FollowingListPage extends StatefulWidget {
  ...
  const FollowingListPage({Key? key, required this.userNumber})
      : super(key: key);
...
class _FollowingListPageState extends State<FollowingListPage> {
  ...
  Future<void> _fetchFollowingList() async {
    ...
    FollowingListResponse followingListResponse =
        await FollowingListResponse.fetchFollowingListResponse(
          ...
          children: <Widget>[
            Expanded(
              child: ListView.builder(
                ...
                itemCount:
                    _followingList.length + 1, // リストアイテム数 + ローディングインジケーター
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            if (following.followedHardWorker)
                                              Padding(
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                        horizontal: 3,
