...
class SearchUserIdListPage extends StatefulWidget {
  ...
  const SearchUserIdListPage({Key? key, required this.keyword}) : super(key: key);
...
class _SearchUserIdListPageState extends State<SearchUserIdListPage> {
  ...
  Future<void> _fetchSearchUserIdList() async {
    ...
    await SearchUserIdListResponse.fetchSearchUserIdListResponse(_page, searchKeyword);
    if (mounted) {
      setState(() {
        _userList
